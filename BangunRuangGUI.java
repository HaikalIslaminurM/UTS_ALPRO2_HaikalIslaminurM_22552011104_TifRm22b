...
public class BangunRuangGUI implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JOptionPane.showMessageDialog(frame, "Volume " + bangun + " adalah " + volume);
    }

    public static void main(String[] args) {
        BangunRuangGUI gui = new BangunRuangGUI();
    }
}